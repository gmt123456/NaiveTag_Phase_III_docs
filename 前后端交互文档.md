...
url: "admin/statistic/workerspeed.html"
return:
{
    "speed" : [12, 12, 32],  // 八种标注方式各自的速度
}

url: "admin/statistic/workerquality.html"
return:
{
    "quality" : [12, 23, 12]  // 八种标注方式各一个维度
}
...
return:
{
    ...
    "tagError" : [0.23, 0.34, 0.11, 0.23, ..., 0.01],
    "speed" : [1234, 234, 34, ... , 34],  // 单位是 pictures per day
    "ability" : [234, 324, 34, ..., 423]，  // 这个能力值统计，数值代表用户的能力向量的长度
    "acceptedTasks" : [
    	[1010, 1200, 4300, ..., 2301],
    	[3001, 2000, 4011, ..., 1010],
    	[3002, 2011, 2012, ..., 1000],
...
url : "admin/statistic/taskclick.html" // 各类型标注任务点击量
return:
{
    "clickTimes" : [32, 21, 23, 12, 32, 11, 32]  // 八个维度分别对应八种标注方式
}
